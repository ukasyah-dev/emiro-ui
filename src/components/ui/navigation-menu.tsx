  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        ...
        "text-accent-foreground/80 hover:bg-accent/80 focus-visible:ring-ring/50",
        ...
        "[&_svg:not([class*='text-'])]:text-muted-foreground focus-visible:ring-[3px] focus-visible:outline-1 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    />
